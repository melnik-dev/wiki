<template>
  <main class="main">
    ...
    <div class="post__wrapper">
      <PostItem v-for="(item, i) in postData" :key="i" :postData="item"/>
      <PostItemDiscus/>
    </div>
  </main>
</template>
...
import PostItemDiscus from "./PostItemDiscus.vue"
      ...
      postData: [
        {
          ...
          text:
              `Иссахар Джейкокс Робертс (англ. Issachar Jacox Roberts, кит. трад. 羅孝全, упр. 罗孝全, пиньинь Luó Xiàoquán, палл. Ло
...
`, textButton: "Читать",
        ...
        },
        {
          ...
          text:
              `Актуальные темы: вспышка оспы обезьян • вторжение России на Украину • лесные пожары в Сибири • пандемия COVID-19 • продовольственный кризис • протесты в Армении | Недавно умершие
